...
<body>
  ...
  <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
    ...
    <form method="POST" id="formulario">
        ...
        <input type="number" id="id_colonia" name="id_colonia" required><br>
        <label form="id_especialidad">especialidad</label>
        <input type="number" id="id_especialidad" name="id_especialidad" required><br>
        <label form="id_genero">genero</label>
        <input type="number" id="id_genero" name="id_genero" required><br>
